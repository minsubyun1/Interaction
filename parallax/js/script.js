...
function scrollFunc(e) {
  ...
  //  parallax_5.style.transform = "translate3d(0px ," + -scrollTop * .26 +"px, 0px)";
...
function loop() {
    ...
    parallax_4.style.transform = "translate(" + mx / 140 + "px ," + -scrollTop * .22 +"px , 0px)"
    parallax_5.style.transfrom = "scale(1.1) translate("+mx/50+"px ," + -scrollTop * .25 +"px)";
    parallax_6.style.transfrom = "scale(1.2) translate("+ -mx/20 +"px ," + -my/20 + "px)"; 
